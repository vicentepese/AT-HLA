...
- [2. Getting Started](#2-getting-started)
  ...
  - [2.2. Initilization](#22-initilization)
    - [2.2.1. Input Data](#221-input-data)
    - [2.2.2. Imputation Probabilities](#222-imputation-probabilities)
    - [2.2.3. Covariates](#223-covariates)
    - [2.2.4 Ethnicity (optional)](#224-ethnicity-optional)
    - [2.2.3. Settings](#223-settings)
- [3. HLA Association Analysis](#3-hla-association-analysis)
  - [3.1 Allele Association Analysis](#31-allele-association-analysis)
    - [3.1.1 Command:](#311-command)
    - [3.1.2 Description:](#312-description)
    - [3.1.3 Outputs and results interpretation:](#313-outputs-and-results-interpretation)
  - [3.2 Logistic Model Analysis](#32-logistic-model-analysis)
    - [3.2.1 Command](#321-command)
    - [3.2.2 Description](#322-description)
    - [3.2.3 Outputs and results interpretation](#323-outputs-and-results-interpretation)
    - [3.2.4 Additional settings](#324-additional-settings)
  - [3.3 Iterative Logistic Model Analysis](#33-iterative-logistic-model-analysis)
    - [3.3.1 Command](#331-command)
    - [3.3.2 Description](#332-description)
    - [3.3.3. Outputs and results interpretation](#333-outputs-and-results-interpretation)
    - [3.3.4 Additional settings](#334-additional-settings)
- [4. Haplotype Analysis](#4-haplotype-analysis)
  - [4.1. Haplotype count](#41-haplotype-count)
    - [4.1.1. Command](#411-command)
    - [4.1.2 Decription](#412-decription)
    - [4.1.3 Settings](#413-settings)
    - [4.1.4  Outputs and results interpretation](#414--outputs-and-results-interpretation)
  - [4.2 Expectation Maximization](#42-expectation-maximization)
    - [4.2.1 Command](#421-command)
    - [4.2.2 Decription](#422-decription)
    - [4.2.3 Settings](#423-settings)
    - [4.2.4  Outputs and results interpretation](#424--outputs-and-results-interpretation)
- [5. Zygosity Analysis](#5-zygosity-analysis)
  - [5.1 Hardy-Weinberg](#51-hardy-weinberg)
    - [5.1.1 Command](#511-command)
    - [5.1.2 Decription](#512-decription)
    - [5.1.3 Settings](#513-settings)
    - [5.1.4  Outputs and results interpretation](#514--outputs-and-results-interpretation)
  - [5.2 Zygosity Analysis](#52-zygosity-analysis)
    - [5.2.1 Command](#521-command)
    - [5.2.2 Decription](#522-decription)
    - [5.2.3  Outputs and results interpretation](#523--outputs-and-results-interpretation)
  - [5.3 Heterozygosity Analysis](#53-heterozygosity-analysis)
    - [5.3.1 Command](#531-command)
    - [5.3.2 Decription](#532-decription)
    - [5.3.3. Settings](#533-settings)
    - [5.3.4  Outputs and results interpretation](#534--outputs-and-results-interpretation)
- [6. Amino Acid Association Analysis](#6-amino-acid-association-analysis)
  - [6.1 Amino Acid Analysis](#61-amino-acid-analysis)
    - [6.1.1 Command](#611-command)
    - [6.1.2 Decription](#612-decription)
    - [6.1.3  Outputs and results interpretation](#613--outputs-and-results-interpretation)
  - [6.2 Amino Acid Logistic Model Analysis](#62-amino-acid-logistic-model-analysis)
    - [6.2.1 Command](#621-command)
    - [6.2.2 Decription](#622-decription)
    - [6.2.3 Additional Settings](#623-additional-settings)
    - [6.2.4  Outputs and results interpretation](#624--outputs-and-results-interpretation)
# 1. Introduction
